    ...
    <>
      ...
      <Container className="border border-dark rounded bg-dark my-4">
        <Row className="my-4 px-5">
          ...
          <Col className="col-6 col-sm-4 col-md-3 text-center">
            <Card className="mx-auto my-3 bg-light d-flex justify-content-center align-items-center" style={cardSize}>
              <Link to="/admin/contact" className="nav-link text-dark">
                <Card.Body>
                  <Card.Title>
                    <Icon icon={faPhone} />
                  </Card.Title>
            ...
            <Card className="mx-auto my-3 bg-light d-flex justify-content-center align-items-center" style={cardSize}>
              <Link to="/admin/authors" className="nav-link text-dark">
                <Card.Body>
                  ...
                  <Card.Text className="text-start" style={{width: '150%'}}>Authors</Card.Text>
                </Card.Body>
              </Link>
            </Card>
          </Col>
          ...
          <Col className="col-6 col-sm-4 col-md-3 text-center">
            <Card className="mx-auto my-3 bg-light d-flex justify-content-center align-items-center" style={cardSize}>
              <Link to="/admin/languages" className="nav-link text-dark">
                <Card.Body>
                  <Card.Title>
                    <Icon icon={faBox} />
                  </Card.Title>
                  <Card.Text className="text-start" style={{width: '150%'}}>Languages</Card.Text>
                </Card.Body>
              </Link>
            </Card>
          </Col>
          ...
          <Col className="col-6 col-sm-4 col-md-3 text-center">
            <Card className="mx-auto my-3 bg-light d-flex justify-content-center align-items-center" style={cardSize}>
              <Link to="/admin/genres" className="nav-link text-dark">
                <Card.Body>
                  <Card.Title>
                    <Icon icon={faBox} />
                  </Card.Title>
                  <Card.Text className="text-start" style={{width: '150%'}}>Genres</Card.Text>
                </Card.Body>
              </Link>
            </Card>
          </Col>
          ...
          <Col className="col-6 col-sm-4 col-md-3 text-center">
            <Card className="mx-auto my-3 bg-light d-flex justify-content-center align-items-center" style={cardSize}>
              <Link to="/admin/countries" className="nav-link text-dark">
                <Card.Body>
                  <Card.Title>
                    <Icon icon={faBox} />
                  </Card.Title>
                  <Card.Text className="text-start" style={{width: '150%'}}>Countries</Card.Text>
                </Card.Body>
              </Link>
            </Card>
          </Col>
